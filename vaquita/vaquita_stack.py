...
class VaquitaStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        #         _ec2.SubnetConfiguration(name="isolated_subnets", cidr_mask=24,reserved=False, subnet_type=_ec2.SubnetType.ISOLATED)
        #     ],
        # )

        ### Optionally we can use provisioned Aurora
        ...
        #     ),
        #     master_user=_rds.Login(username="admin"), #password is automatically generated by Secret Manager (by default)
        # )
